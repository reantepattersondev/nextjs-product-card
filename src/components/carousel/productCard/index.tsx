...
const ProductCard: React.FunctionComponent<ProductTypesense> = (
    ...
    return (
        <div
            className="relative h-420p w-230p bg-white p-3 items-center cursor-pointer rounded-6p"
        ...
        >
            <div className="min-h-full relative">
                ...
                <div className="absolute top-200 min-w-full h-250p">
                ...
                <div className="flex flex-col absolute bottom-0 min-w-full">
                    <div
                        className="flex justify-center min-w-full min-h-25p"
                        onMouseEnter={() => setIsStockShown(true)}
                        onMouseLeave={() => setIsStockShown(false)}
                    >
                        {(props.region || props.vintage) && (
                            <div
                                className="flex justify-center items-center border border-solid border-darkpink rounded-full px-1"
                    ...
                    <div className="text-center text-gray-800 text-lg font-bold line-clamp-2 mt-2 h-48p">
                        {props.product_name}
                    </div>

                    <div
                        className="relative min-w-full mt-4"
                        onMouseEnter={() => setIsAddBtnShown(true)}
                        onMouseLeave={() => setIsAddBtnShown(false)}
                    >
                        <div className="h-40p flex justify-center items-center">
                            {props.in_stock
                        ...
                        >
                            {!props.in_stock && (
                                <button
                                    className={`${styles.buttonFadeIn} bg-gray-400 text-white font-bold py-2 px-3 rounded`}
                                >
                                    Out of Stock
                                </button>
                            )}
